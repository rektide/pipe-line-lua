--- Inheritance utilities for pipecopy
--- Provides helpers for metatable-based inheritance chains
local M = {}
...
--- Create inheritance from multiple parents (left-to-right priority)
---@param parent table[] Array of parent objects
...
---@param obj table Starting object
---@return table[] parent Array of parent objects
