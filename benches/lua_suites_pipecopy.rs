...
const IMPLEMENTATION: &str = "pipecopy";
...
fn benchmark_lua_suites_pipecopy(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("lua_testsuites_pipecopy");
...
criterion_group!(benches, benchmark_lua_suites_pipecopy);
