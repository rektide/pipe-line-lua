...
const IMPLEMENTATION: &str = "single-stage-mode";
...
fn benchmark_lua_suites_single_stage_mode(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("lua_testsuites_single_stage_mode");
...
criterion_group!(benches, benchmark_lua_suites_single_stage_mode);
